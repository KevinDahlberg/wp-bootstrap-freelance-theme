...
<head>
    ...
    <link href="<?php echo get_bloginfo('template_directory'); ?>/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
      ...
      <!-- Theme CSS -->
    <link href="<?php echo get_bloginfo('template_directory'); ?>/styles/blog.css" rel="stylesheet">
...
<div id="skipnav"><a href="#maincontent">Skip to main content</a></div>
    ...
    <script src="<?php echo get_bloginfo('template_directory'); ?>/scripts/jqBootstrapValidation.js"></script>
    <script src="<?php echo get_bloginfo('template_directory'); ?>/scripts/contact_me.js"></script>

    <!-- Theme JavaScript -->
    <script src="<?php echo get_bloginfo('template_directory'); ?>/sctiprs/freelancer.min.js"></script>
